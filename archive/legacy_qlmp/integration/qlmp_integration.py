...
def run_qlmp_integration(
    ...
    *,
    ...
    if candidate_memories is not None and not isinstance(
        candidate_memories, CandidateMemoryBatch
    ):
        raise ValueError("candidate_memories must be a CandidateMemoryBatch or None")
...
def run_projector_isolation(
    ...
    *,
    ...
    if not isinstance(candidate_memories, CandidateMemoryBatch):
