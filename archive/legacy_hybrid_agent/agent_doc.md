...
> **Legacy sandbox scope:** This walkthrough applies only to the historical `experiment_1` tree. For the active implementation, use `system/MEMORY_ARCHITECTURE.md`.
